...
async def subscribe(service_name, clients):
    ...
    for uri in uris:
        ...
        subscribe_tasks.append(asyncio.create_task(_subscribe(client, subscribe_request, publisher)))
...
if __name__ == '__main__':
    ...
    service_config = Path(__file__).resolve().parent.parent / "include" / "service_config_canbus.json"
